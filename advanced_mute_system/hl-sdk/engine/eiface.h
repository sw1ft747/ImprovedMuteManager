...
typedef struct enginefuncs_s
{
	...
	unsigned const char *(*pfnSetFatPVS)			( float *org );
	unsigned const char *(*pfnSetFatPAS)			( float *org );

	int			(*pfnCheckVisibility )		( const edict_t *entity, unsigned const char *pset );

	void		(*pfnDeltaSetField)			( struct delta_s *pFields, const char *fieldname );
	void		(*pfnDeltaUnsetField)		( struct delta_s *pFields, const char *fieldname );
	void		(*pfnDeltaAddEncoder)		( const char *name, void (*conditionalencode)( struct delta_s *pFields, const unsigned const char *from, const unsigned const char *to ) );
...
typedef struct 
{
	...
	void			(*pfnClientUserInfoChanged)( edict_t *pEntity, const char *infobuffer );
	...
	void			(*pfnSetupVisibility)( struct edict_s *pViewEntity, struct edict_s *pClient, unsigned const char **pvs, unsigned const char **pas );
	void			(*pfnUpdateClientData) ( const struct edict_s *ent, int sendweapons, struct clientdata_s *cd );
	int				(*pfnAddToFullPack)( struct entity_state_s *state, int e, edict_t *ent, edict_t *host, int hostflags, int player, unsigned const char *pSet );
	...
	int				(*pfnConnectionlessPacket )	( const struct netadr_s *net_from, const char *args, const char *response_buffer, int *response_buffer_size );
	...
	int				(*pfnInconsistentFile)( const struct edict_s *player, const char *filename, const char *disconnect_message );
